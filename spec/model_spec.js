...
(function() {
  describe("HAL.Model", function() {
    beforeEach(function() {
      ...
      this.collection = new HAL.Collection();
    ...
    describe("when instantiated", function() {
      ...
      it("returns false for isNew when self-link present", function() {
        return expect(this.model.isNew()).toEqual(false);
      });
      return it("sets the collection from the Model options", function() {
        return expect(this.model.collection).toEqual(this.collection);
      });
    });
